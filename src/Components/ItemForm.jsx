  ...
  return (
    <div className="container mt-3">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          <label htmlFor="deactivatedAt" className="form-label">Deactivated At:</label>
          <input
            type="datetime-local"
            className="form-control"
            id="deactivatedAt"
        ...
        <div className="mb-3">
          <label htmlFor="deletedAt" className="form-label">Deleted At:</label>
          <input
            type="datetime-local"
            className="form-control"
            id="deletedAt"
    ...
    <div className="mb-3">
        ...
        <div className="mb-3">
          <label htmlFor="uom" className="form-label">Unit of Measure (UOM):</label>
          <input
            type="text"
            className="form-control"
            id="uom"
