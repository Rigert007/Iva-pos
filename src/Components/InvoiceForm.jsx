...
const InvoiceForm = () => {
    ...
    const handleInvoiceLinesChange = (index, event) => {
        ...
        const newInvoiceLines = invoice.invoiceLines.map(
            (lineItem, lineIndex) => {
                if (index === lineIndex) {
    ...
    return (
        <div className="container mt-3">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                    <label htmlFor="totalVatAmount" className="form-label">
                        Total VAT Amount:
                    </label>
                    <input
                        className="form-control"
                ...
                <div className="mb-3">
                    <label htmlFor="totalDiscountAmount" className="form-label">
                        ...
                        <div className="card-body">
                            ...
                            <div className="mb-3">
                                ...
                                <input
                                    ...
                                    value={line.itemId}
                                    onChange={(e) =>
                                        handleInvoiceLinesChange(index, e)
                                    }
                                    onWheel={(e) => e.target.blur()}
                                />
                            </div>
                            ...
                            <div className="mb-3">
                                <label htmlFor={`discountPercent-${index}`}>
                                    Discount Percent:
                                </label>
                                <input
                                    type="number"
                            ...
                            <div className="mb-3">
                                <label htmlFor={`discountTotalAmount-${index}`}>
                                ...
                                <div className="mb-3">
                                    <label
                                        htmlFor={`totalAfterDiscount-${index}`}
                                    >
                            ...
                            <div className="mb-3">
                                <label htmlFor={`totalIncludingTax-${index}`}>
                                    Notes:
                                </label>
                                <input
                                    type="text"
                ...
                <div className="mb-3">
                    <label htmlFor="totalWoVat" className="form-label">
                        Total Wo Vat:
                    </label>
                    <input
                        className="form-control"
